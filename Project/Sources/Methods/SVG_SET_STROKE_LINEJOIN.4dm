//%attributes = {"invisible":true,"shared":true,"preemptive":"capable"}
  // ----------------------------------------------------
  // Method : SVG_SET_STROKE_LINEJOIN
...
C_TEXT:C284($kTxt_currentMethod;$Txt_linejoin;$Txt_objectID)
...
If ($Lon_parameters>=2)
	...
	If (Asserted:C1132(xml_referenceValid ($Txt_objectID);Get localized string:C991("error_badReference")))
		...
		If (Position:C15($Txt_linejoin+"|";"miter|round|bevel|inherit|")>0)
			
			Component_errorHandler ("init";$kTxt_currentMethod)
			
			DOM SET XML ATTRIBUTE:C866($Txt_objectID;\
				"stroke-linejoin";$Txt_linejoin)
