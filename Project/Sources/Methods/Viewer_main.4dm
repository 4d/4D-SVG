...
Case of 
	...
	: ($Txt_entryPoint="_init")
		...
		SET MENU ITEM PROPERTY:C973($Txt_menu; -1; Associated standard action name:K28:8; _o_Undo action:K59:16)
		...
		SET MENU ITEM PROPERTY:C973($Txt_menu; -1; Associated standard action name:K28:8; _o_Copy action:K59:19)
		SET MENU ITEM SHORTCUT:C423($Txt_menu; -1; "C"; 0)
		
		APPEND MENU ITEM:C411($Txt_menu; Get localized string:C991("CommonMenuItemPaste"))
		SET MENU ITEM PROPERTY:C973($Txt_menu; -1; Associated standard action name:K28:8; _o_Paste action:K59:20)
		...
		SET MENU ITEM PROPERTY:C973($Txt_menu; -1; Associated standard action name:K28:8; _o_Select all action:K59:22)
		...
		SET MENU ITEM PROPERTY:C973($Txt_menu; -1; Associated standard action name:K28:8; _o_Show clipboard action:K59:23)
