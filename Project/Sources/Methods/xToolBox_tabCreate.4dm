...
C_LONGINT:C283($Lon_bottom;$Lon_fontSize;$Lon_i;$Lon_left;$Lon_maxWidth;$Lon_offset)
C_LONGINT:C283($Lon_options;$Lon_right;$Lon_Selected;$Lon_start;$Lon_tabWidth;$Lon_top)
C_LONGINT:C283($Lon_width)
C_POINTER:C301($Ptr_definitionArray;$Ptr_target)
C_TEXT:C284($Dom_root;$Txt_color;$Txt_defsID;$Txt_font;$Txt_groupReference;$Txt_objectID)
C_TEXT:C284($Txt_selected;$Txt_Stop;$Txt_tabRef)
