//%attributes = {}
  // ----------------------------------------------------
  // Project method: 00_beaucoup
  // Database: 4D SVG
  // ID[E040DCA6F8BE4C6A80CED0505C9A1D7A]
...
Case of 
	...
	: ($Txt_entryPoint="_run")
		...
		00_beaucoup ("_declarations")
		00_beaucoup ("_init")
		
		$Win_hdl:=Open form window:C675("Form1";Plain form window:K39:10;Horizontally centered:K39:1;Vertically centered:K39:4;*)
		DIALOG:C40("Form1")
		CLOSE WINDOW:C154
