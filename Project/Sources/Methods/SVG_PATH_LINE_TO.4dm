...
If ($Lon_parameters>=2)
	...
	If ($Lon_parameters>=5)
		...
		For ($Lon_i;2;$Lon_parameters;2)
			...
			$Txt_Command:=$Txt_Command+String:C10(${$Lon_i};"&xml")+","+String:C10(${$Lon_i+1};"&xml")+(" "*Num:C11($Lon_i<($Lon_parameters-1)))
	...
	Else 
		...
		If ($Lon_parameters>=3)
			...
			$Txt_Command:="l"+String:C10($2;"&xml")+","+String:C10($3;"&xml")
