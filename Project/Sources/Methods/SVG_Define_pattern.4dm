...
_O_C_LONGINT:C283($Lon_height; $Lon_parameters; $Lon_width; $Lon_x; $Lon_y)
_O_C_TEXT:C284($Dom_defs; $Dom_pattern; $Dom_root; $kTxt_currentMethod; $Txt_ID; $Txt_patternUnits)
_O_C_TEXT:C284($Txt_rootReference; $Txt_svgObject; $Txt_viewBox)
...
If ($Lon_parameters>=2)
	...
	If (Find in array:C230($tTxt_patternUnits; $Txt_patternUnits)>0)
		...
		Else 
			...
			$Dom_defs:=getDefs($Txt_svgObject)
