...
_O_C_LONGINT:C283($Lon_i; $Lon_parameterIndex; $Lon_parameters; $Lon_rotation; $Lon_x)
_O_C_REAL:C285($Num_opacity; $Num_startOffset; $Num_stopOffset; $Num_value)
_O_C_TEXT:C284($kTxt_currentMethod; $Txt_colorInterpolation; $Txt_defsID; $Txt_ID; $Txt_objectID; $Txt_rootReference)
_O_C_TEXT:C284($Txt_spreadMethod; $Txt_startColor; $Txt_Stop; $Txt_stopColor; $Txt_svgObject)
...
If (False:C215)
	...
	_O_C_REAL:C285(SVG_Define_linear_gradient; ${7})
End if 
